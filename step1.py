...
input_data_directory  = './train31'   ## Directory of the raw images. These images must have high variance.
output_data_directory = './test31' ## Directory to save the faces from the images
